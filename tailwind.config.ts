	...
	theme: {
		...
		extend: {
			colors: {
				...
				chat: {
					'user-bg': 'rgba(18, 24, 38, 0.7)',
					'assistant-bg': 'rgba(25, 33, 52, 0.7)',
				},
				neon: {
					'cyan': '#00FFFF',
					'purple': '#8A2BE2',
			...
			backgroundImage: {
				...
				'cyber-grid': 'linear-gradient(rgba(25, 33, 52, 0.6) 1px, transparent 1px), linear-gradient(90deg, rgba(25, 33, 52, 0.6) 1px, transparent 1px)'
			}
		}
	},
